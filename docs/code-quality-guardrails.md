...
- Broad or risky changes should get a second reviewer when practical. For solo-maintainer changes, treat passing guardrails plus documented risk as the minimum review baseline.
